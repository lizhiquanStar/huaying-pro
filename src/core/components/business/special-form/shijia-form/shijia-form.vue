<template>
  <div class="bs-sign-audit-shijia-form">
    <h2>广安科贸有限公司员工事假申请表</h2>
...
import { BsShijiaFormConfig } from './shijia-form.config';

@Component({})
export default class BsShijiaForm extends Mixins(BsShijiaFormConfig) {
  dataChildObj: any = {};
  bmName = '';
  @Prop({
    type: Object,
...
@include b(bs-sign-audit-shijia-form) {
  h2 {
    color: #000;
    margin: 0 0 10px;
    text-align: center;
