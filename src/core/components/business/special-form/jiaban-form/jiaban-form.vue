<template>
  <div class="bs-sign-audit-jiaban-form">
    <h2>广安科贸有限公司员工加班申请表</h2>
    <table cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td style="width: 15%" colspan="2">加班联系电话</td>
...
import { BsJiabanFormConfig } from './jiaban-form.config';

@Component({})
export default class BsJiabanForm extends Mixins(BsJiabanFormConfig) {
  dataChildObj: any = {};
  bmName = '';
  @Prop({
    type: Object,
...
@include b(bs-sign-audit-jiaban-form) {
  h2 {
    color: #000;
    margin: 0 0 10px;
    text-align: center;
