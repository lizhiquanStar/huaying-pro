<template>
  <div class="bs-sign-audit-binjia-more-form">
    ...
    <table cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="6">一天副总审批，一天以上总经理审批</td>
      </tr>
    </table>
  </div>
</template>
...
import { BsBinjiaMoreFormConfig } from './binjia-more-form.config';

@Component({})
export default class BsBinjiaMoreForm extends Mixins(BsBinjiaMoreFormConfig) {
  dataChildObj: any = {};
  bmName = '';
  @Prop({
    type: Object,
...
@include b(bs-sign-audit-binjia-more-form) {
  h2 {
    color: #000;
    margin: 0 0 10px;
    text-align: center;
